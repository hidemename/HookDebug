...
namespace WHD.Core
{
    public class HookHelper
    {
        ...
        private static extern IntPtr SetWindowsHookEx(HookType idHook, HookProc lpfn, IntPtr hInstance, int threadId);
        ...
        private int HookCallback(int code, IntPtr wParam, ref KBDLLHOOKSTRUCT lParam)
        {
            ...
            return CallNextHookEx(_testhookHandle, code, wParam, ref lParam);
        }
    }
